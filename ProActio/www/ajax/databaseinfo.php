...
$query ="select \"_DbStatus-DbBlkSize\" ,  \"_DbStatus-TotalBlks\"  , \"_DbStatus-EmptyBlks\" ,\"_DbStatus-FreeBlks\" , \"_DbStatus-RMFreeBlks\" ,\"_DbStatus-CreateDate\" , \"_DbStatus-Starttime\" , \"_DbStatus-FbDate\" , \"_DbStatus-IbDate\"  from PUB.\"_DbStatus\"";
...
$row['_DbStatus-FreeBlks']=round($row['_DbStatus-FreeBlks']*$row['_DbStatus-DbBlkSize']/1024/1024,2).'MB';
$row['_DbStatus-RMFreeBlks'] = $row['_DbStatus-TotalBlks']-$row['_DbStatus-FreeBlks'] - $row['_DbStatus-RMFreeBlks']- $row['_DbStatus-EmptyBlks'].'MB';
	$json[]=$row;
	}
