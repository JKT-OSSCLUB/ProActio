...
$query ="select \"_FileList-Name\" , \"_FileList-Extend\" , \"_FileList-Size\" from PUB.\"_Filelist\"";
...
if (!$result) {
	...
	if($row['_FileList-Extend'] == 0)
	$row['_FileList-Extend'] = "Fixed";
	else
	$row['_FileList-Extend'] = "Variable";
	$row['_FileList-Size']=round($row['_FileList-Size']/1024,2).'MB';
        $json[]=$row;
    }
odbc_close($conn);
