 ...
 *
 * atransaction_drv.p
 * driver for Transaction, requiring connection to Progress database and information from VSTs
 *
 * Known Bugs & Issues:
 *
 *
 ...
 */
{connect.i} 
DEFINE VARIABLE iDbup       AS INTEGER     NO-UNDO.
...
DEFINE VARIABLE dThreshold AS INTEGER         NO-UNDO.
ASSIGN dThreshold = 20.
...
REPEAT:                
  ...
  DO:  
        ...
        DO:
            ...
            run value(lcAlProcPath + "a9Transaction.p") (input lcid,input dThreshold). 
        END. 
        ELSE
        DO: 
