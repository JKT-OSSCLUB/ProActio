 ...
 *
 * ausertable_drv.p
 * driver for User table alert, requiring connection to Progress database and information from VSTs
 *
 * Known Bugs & Issues:
 *
 *
...
REPEAT:                
    ...
    DO:            
        ...
        DO:
            ...
            run value(lcAlProcPath + "a5UserTable.p") (input lcid,input dThreshold). 
        END. 
        ELSE
        DO: 
