 ...
 *
 * aareastatus_drv.p
 * driver for Arestatus alert, requiring connection to Progress database and information from VSTs
 *
 * Known Bugs & Issues:
 *
 *
...
REPEAT:                
   ...
   DO:
    ...
    DO:
        ...
        run value(lcAlProcPath + "a10AreaStatus.p") (input lcid,input dThreshold1,input dThreshold2).      
    END. 
    ELSE
    DO: 
