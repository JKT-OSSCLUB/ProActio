 ...
 *
 * abufferhit_drv.p
 * driver for Buffer Hits alert, requiring connection to Progress database and information from VSTs
 *
 * Known Bugs & Issues:
 *
 *
...
DEFINE VARIABLE dThreshold1 AS Decimal NO-UNDO.
DEFINE VARIABLE dThreshold2 AS Decimal NO-UNDO.

ASSIGN dThreshold1 = 90.00
       dThreshold2 = 80.00.
...
REPEAT:                
  ...
  DO:
    ...
    DO:
        ...
        run value(lcAlProcPath + "a12BufferHit.p") (input lcid,input dThreshold1,input dThreshold2). 
    END. 
    ELSE
    DO: 
