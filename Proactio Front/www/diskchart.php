...
ajax = $.ajax({
		  ...
		  beforeSend: function(){
		$("#top_x_div").html('<img style="position: absolute;display: block;top: 45%;left: 42%;" src="images/connectingser.GIF">');
		},
		error: function () {
                  $("#top_x_div").html('<img style="position: absolute;display: block;top: 45%;left: 42%;" src="images/serverinaccessible.gif">');
				   ajax = undefined;
              },
