...
<div class="row">
 ...
 <?php while($row=mysqli_fetch_assoc($query))
	  ...
	  </div><p>Database Connected Users</p></h3>
  </div>
  <div class="panel-body">
<table data-toggle="table"
       data-url="ajax/databaseconnectedusers.php"
    ...
    <tr>
        ...
        <th data-field="_Connect-Type" 
            data-sortable="true">
          	User Type
        </th>
        <th data-field="_Connect-IPAddress" 
            data-sortable="true">
               Device
        </th> 
		<th data-field="_Connect-Time" 
            data-sortable="true">
                 	Connected since
        </th>
