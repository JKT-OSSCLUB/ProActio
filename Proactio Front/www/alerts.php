                ...
                <div class="board">
                 ...
                 <li><a href="#major" data-toggle="tab" title="Major Alerts">
                     ...
                     <li><a href="#minor" data-toggle="tab" title="Minor Alerts">
						...
						<li><a href="#unfixed" data-toggle="tab" title="Unfixed Alert">
                         <span class="round-tabs six">
                              <i class="glyphicon glyphicon-bell"></i><h5>Unfixed</h5>
                         </span> 
                     </a></li>
                     <li><a href="#fixed" data-toggle="tab" title="Fixed alerts">
                     ...
                     <div class="tab-content">
					  ...
					  <div class="container">
						<table data-toggle="table"
						   data-url="ajax/appuserallalerts.php"
...
<script>
var selected = '<?php echo $selecteddb; ?>';
